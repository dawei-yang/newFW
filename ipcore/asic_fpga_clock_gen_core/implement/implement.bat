...
xst -ifn xst.scr
move asic_fpga_clock_gen_core_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\asic_fpga_clock_gen_core_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc asic_fpga_clock_gen_core_exdes.ucf asic_fpga_clock_gen_core_exdes

echo 'Running map'
map -timing -pr b asic_fpga_clock_gen_core_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm asic_fpga_clock_gen_core_exdes -w routed.ncd routed.vhd
cd ..
