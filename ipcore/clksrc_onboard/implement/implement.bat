...
xst -ifn xst.scr
move clksrc_onboard_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clksrc_onboard_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clksrc_onboard_exdes.ucf clksrc_onboard_exdes

echo 'Running map'
map -timing -pr b clksrc_onboard_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clksrc_onboard_exdes -w routed.ncd routed.vhd
cd ..
